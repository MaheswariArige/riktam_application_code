...
?>
<center><h2>Student Details</h2></center></br></br>
<table class="table table-stripped table-bordered table-hover" align="center" cellpadding="4" style="table-layout:fixed;width:600"cellspacing="3">
...
for($i=1;$i<=$total_pages;$i++){
	echo "<a href='x1.php?page=".$i."'>".$i.'&nbsp'.'&nbsp'."</a>";
};
